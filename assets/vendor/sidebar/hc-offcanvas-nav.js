					...
					var A = function (n, e, a) {
							if ("number" == typeof e && ("number" == typeof n || B.length)) {
								var t =
									...
									o = v
										...
										.filter(function () {
											return (
												"number" != typeof a || J(this).is("[data-index=".concat(a, "]"))
											);
										})
									...
									"number" == typeof n
										...
										Z.on(d, function (n) {
											("Tab" === n.key || 9 === n.keyCode) &&
												(n.shiftKey
													? R.activeElement === i[0] && (n.preventDefault(), c.focus())
													: R.activeElement === c[0] && (n.preventDefault(), i.focus()));
										});
								}
							}
						},
						...
						E = function () {
							...
							v.css("transition", "none"),
								...
								(C = v.outerHeight()),
								r.add(
									".hc-offcanvas-nav.".concat(y, ".nav-position-left .nav-container"),
									"transform: translate3d(-".concat(k, "px, 0, 0)"),
								),
								r.add(
									".hc-offcanvas-nav.".concat(y, ".nav-position-right .nav-container"),
									"transform: translate3d(".concat(k, "px, 0, 0)"),
								),
								r.add(
									".hc-offcanvas-nav.".concat(y, ".nav-position-top .nav-container"),
									"transform: translate3d(0, -".concat(C, "px, 0)"),
								),
								r.add(
									".hc-offcanvas-nav.".concat(y, ".nav-position-bottom .nav-container"),
									"transform: translate3d(0, ".concat(C, "px, 0)"),
								),
								r.insert(),
								v.css("transition", ""),
							...
							-1 !== t.indexOf("px") && (k = parseInt(t)),
								...
								(!n || (n && G("pushContent"))) &&
									("string" == typeof z.pushContent
										...
										: (u = z.pushContent instanceof jQuery ? z.pushContent : null)),
								v.css("transition", "none");
							var i = p.hasClass(V),
								c = [
									"hc-offcanvas-nav",
												...
												J.each(e.items, function (n, e) {
													...
													if (e.custom) {
														var t = J('<li class="custom-content">')
															.addClass(e.classes)
															.append(
																J('<div class="nav-item nav-item-custom">').append(
																	a.clone(!0, !0),
																),
															);
														u.append(t);
														...
														i.is("a") && i.attr("tabindex", "0").attr("role", "menuitem"),
															o.length &&
																i.on("click", function (n) {
																	n.stopPropagation(),
																		(J._data(o[0], "events") || {}).click && o[0].click();
																}),
															"#" === i.attr("href") &&
																i.on("click", function (n) {
																	n.preventDefault();
																...
																(q()
																	? i
																			...
																			.filter(function () {
																				...
																				return (
																					!e.subnav.length ||
																					(n.attr("href") && "#" !== n.attr("href").charAt(0))
																				);
																			})
																			.on("click", W)
																	: i
																...
																var p = function (n) {
																	...
																	f = J(
																		'<input type="checkbox" id="'
																			.concat(y, "-")
																			.concat(r, "-")
																			.concat(v, '" class="hc-chk" tabindex="-1">'),
																	)
																		.attr("data-level", r)
																		.attr("data-index", v)
																		.val(s)
									...
									if (0 === m && !1 !== z.insertClose) {
										...
										d
											...
											!0 === z.insertClose
												? s.first().prepend(d)
												: an(z.insertClose) &&
												  ln(d, z.insertClose, s.first().add(s.first().siblings("ul")));
									}
								})(h, v, 0, z.navTitle);
						};
					f
					...
					if (
						...
						if ("number" == typeof n && "number" == typeof e) {
							if (!(a = J("#".concat(y, "-").concat(n, "-").concat(e))).length)
								return void console.warn(
									"HC Offcanvas Nav: level ".concat(n, " doesn't have index ").concat(e),
								);
						} else
							b
								? ((a = v.find(".hc-chk").filter("[value=".concat(b, "]"))), (b = null))
								: !1 === z.closeOpenLevels &&
				...
				function W() {
					if (I()) {
						if (
							...
							z.disableBody &&
								($.removeClass("hc-nav-open"), Y.removeClass("hc-nav-yscroll"), x))
						) {
							if (
								($.css("top", "").scrollTop(x), Y.scrollTop(x), "bottom" === z.position)
							) {
								var n = x;
								setTimeout(function () {
